...
const getRandomShapePosition = (): ShapePosition => 
    Object.values(ShapePositionEnum)[Math.floor(Math.random() * Object.values(ShapePositionEnum).length)];

export const getRandomShapePositions = (numShapePositions: number): ShapePosition[] => 
    Array.from({length: numShapePositions}, () => getRandomShapePosition());